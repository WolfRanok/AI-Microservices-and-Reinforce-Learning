...
def get_args():
    ...
    parser.add_argument("--gpu_of_node_num", type=int, default=7, help="Number of servers")
    parser.add_argument("--min_arrival_rate", type=int, default=5, help="min_arrival_rate")
    parser.add_argument("--max_arrival_rate", type=int, default=7, help="max_arrival_rate")
