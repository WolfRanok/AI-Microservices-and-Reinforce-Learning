...
def get_args():
    ...
    parser.add_argument("--min_arrival_rate", type=int, default=1, help="min_arrival_rate")
    parser.add_argument("--max_arrival_rate", type=int, default=3, help="max_arrival_rate")
