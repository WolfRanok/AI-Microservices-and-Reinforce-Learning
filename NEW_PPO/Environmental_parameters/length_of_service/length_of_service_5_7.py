...
def get_args():
    ...
    parser.add_argument("--min_length_of_f_service", type=int, default=5, help="min_length_of_f_service")
    parser.add_argument("--max_length_of_f_service", type=int, default=7, help="max_length_of_f_service")
    parser.add_argument("--min_length_of_f_service_in_ai", type=int, default=4, help="min_length_of_f_service_in_ai")
