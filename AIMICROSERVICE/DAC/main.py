...
class Agent:
    ...
    def train_ddpg_on_policy(self):
        ...
        for episode in range(1, ITERATION_NUM + 1):
            ...
            while True:
                ...
                # print(get_ms_image_from_state(state))
                done = 0
                # 部署结束
    ...
    def load_model(self):
        ...
        actor_url = f"Model/2025_01_25_actor_target_model_{NODE_NUM}_{MS_NUM}_{AIMS_NUM}_new_state.pth"
        critic_url = f"Model/2025_01_25_critic_target_model_{NODE_NUM}_{MS_NUM}_{AIMS_NUM}_new_state.pth"
